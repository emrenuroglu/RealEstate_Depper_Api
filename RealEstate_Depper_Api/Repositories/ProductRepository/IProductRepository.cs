...
namespace RealEstate_Depper_Api.Repositories.ProductRepository
{
    public interface IProductRepository
    {
        ...
        Task<List<ResultpProductWithCategoryDto>> GetAllProductWithCategoryAsync();
        ...
        Task<List<ResultpProductWithCategoryDto>> GetProductByDealOfTheDayTrueWithCategoryAsync();
